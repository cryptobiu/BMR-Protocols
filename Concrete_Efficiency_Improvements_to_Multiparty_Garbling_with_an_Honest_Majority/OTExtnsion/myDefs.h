...
#define TEST_ROUNDS 1//1//5//11 //number of times to repeat, for timing testing. TEST_ROUNDS>11 cancels printing of results. TEST_ROUNDS=1 cancels averaging of times.
//#define TEST
